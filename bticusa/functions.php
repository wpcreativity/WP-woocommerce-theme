...
function twentysixteen_widgets_init() {
	register_sidebar(
		array(
			'name'          => __( 'Product Categories', 'twentysixteen' ),
			'id'            => 'sidebar-1',
			'description'   => __( 'Add widgets here to appear in your sidebar.', 'twentysixteen' ),
			'before_widget' => '<aside id="%1$s" class="widget %2$s Categories">',
			'after_widget'  => '</aside>',
...
//add filter
add_filter ('woocommerce_show_page_title', 'btic_show_page_title');
...
//Add Action
add_action ('woocommerce_before_main_content', 'btic_output_content_wrapper', 10);
add_action ('woocommerce_after_main_content', 'btic_output_content_wrapper_end', 10);
add_action ('woocommerce_before_shop_loop_item', 'bticusa_product_listing', 10);

add_action ('woocommerce_before_single_product_summary', 'bticusa_product_images', 20);
add_action ('woocommerce_single_product_summary', 'bticusa_product_details', 40);
